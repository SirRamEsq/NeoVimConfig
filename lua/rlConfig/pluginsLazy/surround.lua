...
--
-- Note that surrounding with an opening delimiter (e.g. `(`) will add a space before/after the selection
-- while surrounding with the closing delimiter (e.g. `)`) will not include the spaces.
